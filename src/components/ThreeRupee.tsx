...
function RupeeMesh({ scrollRef }: { scrollRef: React.MutableRefObject<number> }) {
  ...
  useFrame((_state, delta) => {
    ...
    // --- THE SWING MATH ---
    // Desktop: Uses your perfect 3.5 padding to stay safely on screen.
    // Mobile: Uses a wide 4.5 swing to deliberately fly off the screen edges!
    const horizontalSwing = isMobile
      ? 4.5
    ...
    // Smooth movement execution (NO SCALE COMPRESSION AT ALL)
